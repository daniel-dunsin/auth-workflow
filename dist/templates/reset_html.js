...
exports.password_reset_email = exports.verify_email_html = void 0;
const verify_email_html = (username, link) => {
    return `<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
...
exports.verify_email_html = verify_email_html;
const password_reset_email = (username, link) => `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
...
`;
exports.password_reset_email = password_reset_email;
